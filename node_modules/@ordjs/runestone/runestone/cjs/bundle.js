...
// runestone/cjs/index.js
var imports = {};
imports["__wbindgen_placeholder__"] = module.exports;
var wasm;
var { TextDecoder, TextEncoder, inspect } = require("util");
...
module.exports.decodeHex = function(s) {
  const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
  const len0 = WASM_VECTOR_LEN;
  const ret = wasm.decodeHex(ptr0, len0);
  return takeObject(ret);
};
module.exports.encodeHex = function(bytes2) {
  let deferred1_0;
  let deferred1_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    wasm.encodeHex(retptr, addHeapObject(bytes2));
...
function _assertChar(c) {
  if (typeof c === "number" && (c >= 1114112 || c >= 55296 && c < 57344))
    throw new Error(`expected a valid Unicode scalar value, found ${c}`);
}
module.exports.create_tx = function(input) {
  let deferred1_0;
  let deferred1_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
var EdictFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_edict_free(ptr >>> 0));
var Edict = class _Edict {
  static __unwrap(jsValue) {
    if (!(jsValue instanceof _Edict)) {
      return 0;
    }
  ...
  [inspect.custom]() {
    return Object.assign(/* @__PURE__ */ Object.create({ constructor: this.constructor }), this.toJSON());
  }
  __destroy_into_raw() {
...
module.exports.Edict = Edict;
var EtchingFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_etching_free(ptr >>> 0));
var Etching = class _Etching {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_Etching.prototype);
    obj.__wbg_ptr = ptr;
  ...
  */
  set divisibility(arg0) {
    wasm.__wbg_set_etching_divisibility(this.__wbg_ptr, isLikeNone(arg0) ? 16777215 : arg0);
  }
  /**
  ...
  */
  get rune() {
    ...
    return ret === 0 ? void 0 : Rune.__wrap(ret);
  }
  /**
  ...
  */
  get symbol() {
    ...
    return ret === 16777215 ? void 0 : String.fromCodePoint(ret);
  }
  /**
  * @param {string | undefined} [arg0]
  */
  set symbol(arg0) {
    const char0 = isLikeNone(arg0) ? 16777215 : arg0.codePointAt(0);
    if (char0 !== 16777215) {
      _assertChar(char0);
    }
  ...
  */
  get terms() {
    ...
    return ret === 0 ? void 0 : Terms.__wrap(ret);
  }
  /**
...
module.exports.Etching = Etching;
var RangeFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
...
var RuneFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_rune_free(ptr >>> 0));
var Rune = class _Rune {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_Rune.prototype);
    obj.__wbg_ptr = ptr;
...
var RuneIdFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_runeid_free(ptr >>> 0));
var RuneId = class _RuneId {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_RuneId.prototype);
    obj.__wbg_ptr = ptr;
  ...
  */
  next(block, tx) {
    ...
    return ret === 0 ? void 0 : _RuneId.__wrap(ret);
  }
  /**
  * @returns {string}
  */
...
module.exports.RuneId = RuneId;
var RunestoneFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_runestone_free(ptr >>> 0));
var Runestone = class _Runestone {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_Runestone.prototype);
    obj.__wbg_ptr = ptr;
  ...
  */
  get etching() {
    ...
    return ret === 0 ? void 0 : Etching.__wrap(ret);
  }
  /**
  ...
  */
  get mint() {
    ...
    return ret === 0 ? void 0 : RuneId.__wrap(ret);
  }
  /**
...
module.exports.Runestone = Runestone;
var SpacedRuneFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_spacedrune_free(ptr >>> 0));
var SpacedRune = class _SpacedRune {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_SpacedRune.prototype);
    obj.__wbg_ptr = ptr;
  ...
  */
  static fromString(s) {
    try {
      ...
      return _SpacedRune.__wrap(r0);
    } finally {
      wasm.__wbindgen_add_to_stack_pointer(16);
    }
  }
};
module.exports.SpacedRune = SpacedRune;
var TermsFinalization = typeof FinalizationRegistry === "undefined" ? { register: () => {
}, unregister: () => {
} } : new FinalizationRegistry((ptr) => wasm.__wbg_terms_free(ptr >>> 0));
var Terms = class _Terms {
  static __wrap(ptr) {
    ptr = ptr >>> 0;
    const obj = Object.create(_Terms.prototype);
    obj.__wbg_ptr = ptr;
...
module.exports.__wbg_edict_unwrap = function(arg0) {
...
module.exports.__wbg_codePointAt_158806992b6482b1 = function(arg0, arg1) {
...
module.exports.__wbg_fromCodePoint_cedd7612a2ff688f = function() {
  return handleError(function(arg0) {
...
var path = require("path").join(__dirname, "index_bg.wasm");
